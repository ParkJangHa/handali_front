...
export default function HabitCategoryScreen({ navigation }) {
    ...
    const getImageSource = () => {
        switch (selectedType) {
            case "활동":
                return require('../image/activity.png'); // 활동 이미지
            case "지적":
                return require('../image/intelligent.png'); // 지적 이미지
            case "예술":
                return require('../image/art.png'); // 예술 이미지
            default:
                return require('../image/default.png'); // 기본 이미지
        }
    };
